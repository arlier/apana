...
TLegend *apqslegend = new TLegend(0.5,0.7,.9,0.9);
	...
	Hist_2damp=new TH2F("2damp","amplitude and hit time",100,0,__WaveLength,100,0,150);
	Hist_2dqdc=new TH2F("2dqdc","charge and hit time",100,0,__WaveLength,100,0,50);
...
Hist_bsl[1]->GetXaxis()->SetRangeUser(Hist_bsl[1]->GetMean()-2,2+1.*Hist_bsl[1]->GetMean());
...
Hist_apqsumaf[3]->GetXaxis()->SetRangeUser(0,20000);
...
if(i>140&&i<1000&&Hist_apqsumaf[3]->GetBinContent(i)>apgv[2]){apgt[2]=i;apgv[2]=Hist_apqsumaf[3]->GetBinContent(i);}
if(i>1000&&i<2000&&Hist_apqsumaf[3]->GetBinContent(i)>apgv[3]){apgt[3]=i;apgv[3]=Hist_apqsumaf[3]->GetBinContent(i);}
}
