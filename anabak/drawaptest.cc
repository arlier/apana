...
int main(){
TString filedir0="/home/pmthome/aptest/Analysis_cy/ap636test0.txt";
TString filedir1="/home/pmthome/aptest/Analysis_cy/outap.txt";
...
dte3->GetXaxis()->SetRangeUser(0,1000);
...
aplegend->AddEntry(dte0,"HV=1740V","l");
aplegend->AddEntry(dte1,"HV=1740V,wo EMF shielding","l");
aplegend->AddEntry(dte2,"HV=1540V","l");
aplegend->AddEntry(dte3,"HV=1940V","l");
aplegend->Draw();



//mycanvas->SaveAs("ap636.eps");
mycanvas->SaveAs("ap636.pdf");
mycanvas->SaveAs("ap636.png");
